    ...
    return (
        ...
        <Header />
            ...
            <div className="form-group">
                ...
                <input type="text" onChange={(event) => setIDno(event.target.value)} className="control-form" />
            </div>

            <div className="form-group">
                <label>Gender</label>
                <input type="text" onChange={(event) => setGender(event.target.value)} className="control-form" />
            </div>

            <div className="form-group">
                <label>contact</label>
                <input type="text" onChange={(event) => setContact(event.target.value)} className="control-form" />
            </div>
            ...
            <div className='form-group'>
                ...
                <div className="form-group">
                    ...
                    <input type="text" onChange={(event) => setKinName(event.target.value)} className="control-form" />
                </div>

                <div className="form-group">
                    <label>Next of Kin Surname</label>
                    <input type="text" onChange={(event) => setKinSurname(event.target.value)} className="control-form" />
                </div>

                <div className="form-group">
                    <label>Next of Kin Contact</label>
                    <input type="text" onChange={(event) => setKinContact(event.target.value)} className="control-form" />
                </div>
            ...
            <div className="form-group">
                ...
                <button onClick={() => submit()}>Create Password</button>
